...
if os.path.exists(file_2025) and os.path.exists(file_2026):
    ...
    * **향후 집중 방향:** 시스템으로 방어한 여력을 **'통합 영업(업무/영업용)'**과 **'마케팅분석 고도화 & 시각화 결과 공유'** 등에 집중 투입하여 비즈니스 임팩트 극대화를 위해 노력하겠습니다.
    * **핵심 전략 과제:** 시각화된 대시보드를 통해 핵심 수요처의 월별 가스 사용량 패턴과 이상 징후(타 연료 전환 가능성 등)를 실시간으로 모니터링하고, 이탈하기 전에 선제적으로 대응하는 **'방어형 수익 수성'**에 분석 역량을 집중하겠습니다.
    """)
